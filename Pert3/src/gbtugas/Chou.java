            ...
            if (i >= 2) {
                ...
                if (i == months.length) {
                    System.out.println(((i - 2) > 25 ? alpha[((i - 2) / 25) - 1] + alpha[((i - 2) % 25) - 1]
                            : alpha[i - 2]) + ". Data bulan ke-" + (i + 1) + " | unit terjual = ??? | Data Peramalan = "
                            + dataPeramalan + " Relative Deviation = ???");
                } else {
                    int selisihBulanDenganPeramalan = Math.abs(months[i] - dataPeramalan);
                    int relativeDeviation = (int) Math.round((double) selisihBulanDenganPeramalan / months[i] * 100);
                    // output
                    System.out.println(((i - 2) > 25 ? alpha[((i - 2) / 25) - 1] + alpha[((i - 2) % 25) - 1]
            ...
            if (i >= 3) {
                ...
                if (i == months.length) {
                    System.out.println(((i - 3) > 25 ? alpha[((i - 3) / 25) - 1] + alpha[((i - 3) % 25) - 1]
                            : alpha[i - 3]) + ". Data bulan ke-" + (i + 1) + " | unit terjual = ??? | Data Peramalan = "
                            + dataPeramalan + " Relative Deviation = ???");
                } else {
                    int selisihBulanDenganPeramalan = Math.abs(months[i] - dataPeramalan);
                    int relativeDeviation = (int) Math.round((double) selisihBulanDenganPeramalan / months[i] * 100);
            ...
            if (i >= 4) {
                ...
                if (i == months.length) {
                    System.out.println(((i - 4) > 25 ? alpha[((i - 4) / 25) - 1] + alpha[((i - 4) % 25) - 1]
                            : alpha[i - 4]) + ". Data bulan ke-" + (i + 1) + " | unit terjual = ??? | Data Peramalan = "
                            + dataPeramalan + " Relative Deviation = ???");
                } else {
                    int selisihBulanDenganPeramalan = Math.abs(months[i] - dataPeramalan);
                    int relativeDeviation = (int) Math.round((double) selisihBulanDenganPeramalan / months[i] * 100);
